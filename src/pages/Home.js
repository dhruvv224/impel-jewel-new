 ...
 const { data: popupData } = useQuery({
  ...
  >
    ...
    >
      ...
      <SEO
        title="Home"
        description="Discover exquisite jewelry at Impel Store. Browse our collection of rings, necklaces, and more. Government certified gold jewelry with 50+ years of manufacturing experience."
        keywords="jewelry, gold jewelry, certified gold, rings, necklaces, Indian jewelry"
        ogImage={hero?.[0]?.image || banner_1}
        canonicalUrl="https://impelstore.com"
      />
      <WomansClub />
      {/* Hero Banner */}
